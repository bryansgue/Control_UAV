 function [f,solver,args] = mpc_drone(chi,bounded, N, L, ts, Q, R, obs)
...
% INERCIAL MATRIX
M11=chi(1);     M12=0;        M13=0;       M14=chi(2);
M21=0;          M22=chi(3);   M23=0;       M24=chi(4);
M31=0;          M32=0;        M33=chi(5);  M34=0;
M41=b*chi(6);   M42=a*chi(7); M43=0;       M44=chi(8)*(a^2 + b^2)+chi(9);

M=[M11,M12,M13,M14;M21,M22,M23,M24;M31,M32,M33,M34;M41,M42,M43,M44];

%% CENTRIOLIS MATRIX
C11=chi(10);        C12=w*chi(11);     C13=0;        C14=a*w*chi(12);
C21=w*chi(13);    C22=chi(14);       C23=0;        C24=b*w*chi(15);
C31=0;            C32=0;             C33=chi(16);  C34=0;
C41=a*w*chi(17);  C42=b*w*chi(18);   C43=0;        C44=chi(19);
